      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-purple-100 leading-relaxed">
              ...
              compassionate service in Pune since 2010.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/services/restorative/coloured"
                  className="text-purple-100 hover:text-white transition-colors duration-200 flex items-center"
                >
                  <svg
                    className="w-4 h-4 mr-2"
                  ...
                  Restrative Dentistry
                </Link>
              </li>
              <li>
                <Link
                  href="/services/preventive/oral"
                  className="text-purple-100 hover:text-white transition-colors duration-200 flex items-center"
                >
                  <svg
                    className="w-4 h-4 mr-2"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-purple-100">+91 76200 03733</span>
              </div>
              <div className="flex items-center">
                <svg
                  className="w-5 h-5 mr-3 text-purple-200"
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-4">
                <Link
                  href="https://www.facebook.com/prudentiamicrodental"
                ...
                <Link
                  href="https://www.instagram.com/prudentmicrodentist/"
                  className="w-10 h-10 rounded-full bg-purple-800 hover:bg-purple-700 flex items-center justify-center transition-colors"
                >
                  <svg
                    className="w-5 h-5"
        ...
        <div className="border-t border-purple-800 mt-12 pt-8 text-center">
          <p className="text-purple-300 text-sm">
            &copy; {new Date().getFullYear()} Prudentia Micro Dental Care. All
            rights reserved.
          </p>
